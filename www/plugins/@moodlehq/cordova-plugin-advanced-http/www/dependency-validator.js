cordova.define("@moodlehq/cordova-plugin-advanced-http.dependency-validator", function(require, exports, module) { module.exports = function init(global, console, messages) {
  var interface = {
