cordova.define("@moodlehq/phonegap-plugin-push.PushNotification", function(require, exports, module) { /**
...
module.exports = {
  ...
  getPublicKey: function getPublicKey(successCallback, errorCallback) {
